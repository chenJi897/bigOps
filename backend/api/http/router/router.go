...
func Setup(mode string) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		authGroup.Use(middleware.CasbinMiddleware())
		{
			...
			authGroup.POST("/tasks/:id/request-approval", taskHandler.RequestApproval)
			authGroup.GET("/tasks/:id/approvals", taskHandler.ListTaskApprovals)
			authGroup.GET("/task-approvals/pending", taskHandler.ListPendingApprovals)
			authGroup.POST("/task-approvals/:id/approve", taskHandler.ApproveExecution)
			authGroup.POST("/task-approvals/:id/reject", taskHandler.RejectExecution)
			...
			authGroup.POST("/inspection/templates/:id/delete", inspectionHandler.DeleteTemplate)
			...
			authGroup.POST("/inspection/plans/:id/delete", inspectionHandler.DeletePlan)
