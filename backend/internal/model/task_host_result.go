...
type TaskHostResult struct {
	...
	Status       string     `gorm:"size:20;index;default:pending" json:"status"` // pending/running/success/failed/timeout/canceled
	ExitCode     int        `json:"exit_code"`
	Stdout       string     `gorm:"type:longtext" json:"stdout"`
	Stderr       string     `gorm:"type:longtext" json:"stderr"`
	DurationMs   int64      `gorm:"default:0" json:"duration_ms"`
	ErrorSummary string     `gorm:"size:512" json:"error_summary"`
