      ...
      <el-table :data="tableData" v-loading="loading" stripe border @row-click="openTicket" style="cursor: pointer;">
        ...
        <el-table-column label="操作" fixed="right" min-width="180">
          <template #default="{ row }">
            ...
            <el-button link type="primary" size="small" @click="quickApprove(row)">通过</el-button>
            <el-button link type="danger" size="small" @click="openAction(row, 'reject')">拒绝</el-button>
          </template>
        </el-table-column>
      </el-table>
